...
import com.underground.undergroundmod.model.ModelLaser;
...
public class RenderLaser extends Render<EntityLaser>{
	private static final ResourceLocation texture = new ResourceLocation(ModIdHolder.MODID+":textures/entity/lasermodel.png");
	private final ModelLaser modelBullet = new ModelLaser();
	...
	protected ResourceLocation getEntityTexture(EntityLaser entity) {
	   ...
	   protected void func_203085_b(EntityLaser p_203085_1_, double p_203085_2_, double p_203085_4_, double p_203085_6_, float p_203085_8_, float p_203085_9_) {
